...
func HPAName(instance *skygptv1alpha1.EnterpriseAgent) string {
	return instance.Name
}

// IsHPAEnabled returns true if auto-scaling is enabled for the instance
func IsHPAEnabled(instance *skygptv1alpha1.EnterpriseAgent) bool {
...
// BuildHPA creates a HorizontalPodAutoscaler for the EnterpriseAgent
func BuildHPA(instance *skygptv1alpha1.EnterpriseAgent) *autoscalingv2.HorizontalPodAutoscaler {
