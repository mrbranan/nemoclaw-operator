...
var (
	reconcileTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "enterprise_agent_reconcile_total",
	...
	reconcileDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "enterprise_agent_reconcile_duration_seconds",
	...
	instancePhase = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "enterprise_agent_instance_phase",
	...
	resourceCreationFailures = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "enterprise_agent_resource_creation_failures_total",
	...
	managedInstances = prometheus.NewGauge(
		prometheus.GaugeOpts{
			Name: "enterprise_agent_managed_instances",
	...
	autoUpdateChecksTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "enterprise_agent_autoupdate_checks_total",
	...
	autoUpdateAppliedTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "enterprise_agent_autoupdate_applied_total",
	...
	autoUpdateRollbacksTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "enterprise_agent_autoupdate_rollbacks_total",
	...
	instanceInfo = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "enterprise_agent_instance_info",
	...
	instanceReady = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "enterprise_agent_instance_ready",
