...
func (r *EnterpriseAgentReconciler) reconcileRestore(ctx context.Context, instance *skygptv1alpha1.EnterpriseAgent) (result ctrl.Result, done bool, _ error) {
	...
	if instance.Status.Phase != skygptv1alpha1.PhaseRestoring {
		instance.Status.Phase = skygptv1alpha1.PhaseRestoring
	...
	if condType == batchv1.JobFailed {
		...
		meta.SetStatusCondition(&instance.Status.Conditions, metav1.Condition{
			Type:    skygptv1alpha1.ConditionTypeRestoreComplete,
